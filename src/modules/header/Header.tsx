...
const Header = () => {
  ...
  return (
    <header className=" h-[82px] bg-[#2A2A2A] px-[10px] py-[20px]">
      <div className="container">
        <div className="flex justify-between items-center">
          <Link to={"/"}>
            <span className=" text-[20px] text-[#FFF] font-bold md:text-[26px]">
              Studiopresto
            </span>
          </Link>
          ...
          <div className=" flex justify-between items-center gap-5">
            <Link className=" relative block" to={"/basket"}>
              ...
              <div className=" flex items-center justify-center w-[min-content] h-[16px] absolute top-[-6px] px-[2px] right-[-8px] text-[#FFF] bg-[#F9A43F] rounded">
                {totalCountProducts.length}
              </div>
            </Link>
          </div>
        </div>
