...
const BasketCard: React.FC<BasketItem> = memo(({image, title, price, count, minus, plus, deleteProduct, id}) => {
    ...
    return <article className=' flex justify-center items-center gap-[5px]  m-[0_auto] sm:w-[540px] md:w-[630px]'>
              ...
              <div className=' text-[#2A2A2A] text-[14px] mt-[10px] font-normal m-[0_auto] sm:text-[16px]'>{price} &#36;</div>
              ...
              <span className='text-[16px] font-medium text-black'>{count ? count : 1}</span>
              <button onClick={() => plus(id)} className='font-medium text-[20px] bg-transparent sm:text-[25px]'>+</button>
              </div>
